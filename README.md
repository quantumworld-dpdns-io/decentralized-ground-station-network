...
> Decentralized ground station network – coordinates private/university ground stations using proof-of-reception receipts
...
```bash
# Clone the repo
git clone https://github.com/quantumworld-dpdns-io/decentralized-ground-station-network.git
cd decentralized-ground-station-network
```
